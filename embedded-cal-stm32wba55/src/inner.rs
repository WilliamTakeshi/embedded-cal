...
use stm32_metapac::{
    ...
    rng,
    rng::vals::{Clkdiv, Htcfg, Nistc, RngConfig1, RngConfig2, RngConfig3},
};
...
impl Stm32wba55CalInner {
    pub(crate) fn new_inner(hash: hash::Hash, rcc: &rcc::Rcc, rng: rng::Rng) -> Self {
    ...
    pub fn init_rng(&mut self) -> Result<(), try_rng::RngError> {
