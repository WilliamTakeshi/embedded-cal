...
/// Pass-through of the EC plumbing: the extender adds nothing on top of it, but has to forward it
/// so that users of the extended CAL can still reach the back-end's accelerated primitives.
