...
// This test double has no ECDSA support; it only exists to exercise the hash/HMAC/HKDF
// composition, so EcdsaP256 is stubbed the same way EmptyCal<true> stubs it.
impl embedded_cal::plumbing::sign::EcdsaP256 for DummySha256 {
